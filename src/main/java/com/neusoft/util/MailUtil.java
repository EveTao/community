...
public class MailUtil {
    ...
    public static String myEmailAccount = "17608297994@163.com";
    public static String myEmailPassword = "TQ20170830TQ";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "208702415@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailActiveCode) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "我的layui社区", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "XX用户", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("我的layui社区激活码", "UTF-8");
        String activeUrl="http://10.25.44.136:8080/user/activemail/"+mailActiveCode;
